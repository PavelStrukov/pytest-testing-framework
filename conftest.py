...
def get_manager(manager_type=None):
    ...
    if manager_type is None:
        with open(str(defenitions.ROOT_DIR) + "/database_testing/configs/databaseconfig.yml", "r") as yml_file:
        ...
        with open(str(defenitions.ROOT_DIR) + "/database_testing/configs/database_replication_config.yml",
                  "r") as yml_file:
